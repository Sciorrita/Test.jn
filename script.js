...
function endQuiz() {
    ...
    // Guardar el puntaje del jugador en localStorage
    const playerData = {
    ...
    window.location.href = "scores.html"; // Página donde se mostrará el puntaje
}

// Iniciar el cuestionario cuando la página cargue
window.onload = function() {
    showQuestion();  // Asegúrate de llamar a showQuestion() cuando cargue la página
};